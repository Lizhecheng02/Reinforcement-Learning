...
class Agent():
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims,
                 ...
                 replace=100000, chkpt_dir='tmp/dueling_double_dqn'):
        ...
        self.q_eval = DuelingDeepQNetwork(
            ...
            name='lunar_lander_dueling_double_dqn_q_eval',
        ...
        self.q_next = DuelingDeepQNetwork(
            ...
            self.n_actions,
            input_dims=self.input_dims,
            name='lunar_lander_dueling_double_dqn_q_next',
            chkpt_dir=self.chkpt_dir
        )
    ...
    def learn(self):
        ...
        q_pred = torch.add(
            V_s, (A_s - A_s.mean(dim=1, keepdim=True)))[indices, actions]
