...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims,
                 fc2_dims, n_actions, name, chkpt_dir='ddpg/'):
...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau, env,
                 gamma=0.99, n_actions=2, max_size=10000000,
    ...
    def choose_action(self, observation):
        ...
        observation = torch.tensor(
            observation, dtype=torch.float).to(self.actor.device)
    ...
    def learn(self):
        ...
        new_state = torch.tensor(
            new_state, dtype=torch.float).to(self.critic.device)
